...
GO
CREATE PROCEDURE employees_with_childs AS
BEGIN
...
EXEC employees_with_childs 


--2.	Вивести список дітей, яким відали подарунки в вказаний період.
DROP PROCEDURE childs_with_gifts

GO
CREATE PROCEDURE childs_with_gifts AS
BEGIN
